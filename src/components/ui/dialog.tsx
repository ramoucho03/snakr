...
export function ModalContent({
  ...
  return (
    <Dialog.Portal>
      ...
      <Dialog.Content
        className={cn(
          "glass-strong fixed left-1/2 top-1/2 z-50 w-[min(94vw,32rem)] max-h-[88vh] -translate-x-1/2 -translate-y-1/2 overflow-y-auto rounded-2xl p-6 focus:outline-none",
